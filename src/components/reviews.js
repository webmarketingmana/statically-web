  ...
  return (
    <section className="mt-20 mb-24 max-w-4xl mx-auto px-4 md:px-0">
      <h2 className="text-center font-extrabold text-5xl mx-auto mb-20">
        What do people say about Statically?
      </h2>
      ...
      <div className="flex content-center flex-wrap">
        ...
        >
          ...
          <div className="md:flex">
            <img className="h-12 w-12 rounded-full mx-auto md:mx-0 md:mr-4" src="https://cdn.statically.io/img/github.com/fransallen.png" alt="Frans"/>
        ...
        >
          ...
          <div className="md:flex">
            <img className="h-12 w-12 rounded-full mx-auto md:mx-0 md:mr-4" src="https://cdn.statically.io/img/github.com/leonstafford.png" alt="Leon"/>
            <div className="text-center md:text-left">
        ...
        >
          ...
          <div className="md:flex">
            <img className="h-12 w-12 rounded-full mx-auto md:mx-0 md:mr-4" src="https://cdn.statically.io/img/github.com/ayesh.png" alt="Ayesh"/>
            <div className="text-center md:text-left">
