...
function SponsorPlatinum2() {
  return (
    <div className="flex content-center items-center max-w-4xl mx-auto flex-wrap">
      <div className="w-full sm:w-1/2 md:w-1/6 lg:w-1/6 p-2 md:ml-8">
        <a
          href="https://ns1.com"
      ...
      <div className="w-full sm:w-1/2 md:w-1/6 lg:w-1/6 p-2 md:-ml-12">
        <a
      ...
      <div className="w-full sm:w-1/2 md:w-1/6 lg:w-1/6 p-2">
        <a
