...
class IndexPage extends React.Component {
  ...
  handleSubmit = e => {
    ...
    // TODO: Parse URL here, add result URL, etc.
  }
  render() {
    return (
      <Layout>
        ...
        <div className="px-4 py-8 md:p-8">
          ...
          <section className="mb-24 text-center max-w-4xl mx-auto p-0 md:px-8">
            ...
            <form className="container mb-20" onSubmit={this.handleSubmit}>
              <input name="paste" className="bg-white focus:outline-none border border-gray-300 rounded-lg py-3 px-5 block w-2/3 appearance-none leading-normal mx-auto shadow-lg focus:shadow-xl text-center text-lg" type="url" value={this.state.paste} onChange={this.handleInputChange} placeholder="Paste a GitHub, GitLab, Bitbucket file, or Gist URL here!" />
            </form>
