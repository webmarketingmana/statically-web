    ...
    <Layout>
      ...
      <div className="max-w-2xl mx-auto px-8 md:px-0">
        ...
        <section className="mt-20 mb-24">
          ...
          <h3 className="font-semibold text-2xl">Information Collection And Use</h3>
          ...
          <h4 className="font-semibold text-xl">Types of Data Collected</h4>
          <h5 className="font-semibold mt-4">Personal Data</h5>
          ...
          <h5 className="font-semibold">Tracking &amp; Cookies Data</h5>
          ...
          <h3 className="font-semibold text-2xl">Transfer of Data</h3>
          ...
          <h3 className="font-semibold text-2xl">Disclosure of Data</h3>
          <h4 className="font-semibold text-xl mt-4">Legal Requirements</h4>
          ...
          <h4 className="font-semibold text-xl">Security of Data</h4>
          ...
          <h3 className="font-semibold text-2xl">Service Providers</h3>
          ...
          <h4 className="font-semibold text-xl">CDN for Main Site (Content Delivery Network)</h4>
          ...
          <h4 className="font-semibold text-xl">CDN (Content Delivery Network)</h4>
          ...
          <h3 className="font-semibold text-2xl">Links To Other Sites</h3>
          ...
          <h3 className="font-semibold text-2xl">Children&rsquo;s Privacy</h3>
